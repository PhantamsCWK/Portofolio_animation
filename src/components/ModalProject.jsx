...
const ModalProject = ({ setProjectId, projectId }) => {
  ...
  return (
    data && (
        <div className="px-5 fixed h-full w-full flex items-center justify-center top-0 left-0 z-50 bg-tertiary bg-opacity-50 " id='modal-project' onClick={(e) => e.target?.id === "modal-project" ? handleClose() : "" }>
          <motion.div
